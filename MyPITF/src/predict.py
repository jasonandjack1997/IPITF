...
p.add_argument("-it", "--in_test_file", help="input test file", type=str, default="sample_2.test")
p.add_argument("-m", "--modelfile", help="input model file", type=str, default="sample_2.model")
